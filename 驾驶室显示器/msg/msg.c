	...
	*/
	...
	J1939_MESSAGE->Mxe.Data[3],J1939_MESSAGE->Mxe.Data[4],J1939_MESSAGE->Mxe.Data[5],J1939_MESSAGE->Mxe.Data[6],J1939_MESSAGE->Mxe.Data[7]);
				USART_STR(USART2,data);
						...
						CheckLLRE(J1939_MESSAGE,&LLRE);
				
						sprintf(data,"\n**PGN : %X Blade_Elevation_Deviation___Left:%f **\n",J1939_MESSAGE->Mxe.PGN,LLRE.Blade_Elevation_Deviation___Left);
						USART_STR(USART2,data);
					sprintf(data,"\n**PGN : %X Blade_Elevation_Deviation___Right:%f **\n",J1939_MESSAGE->Mxe.PGN,LLRE.Blade_Elevation_Deviation___Right);
						USART_STR(USART2,data);
					sprintf(data,"\n**PGN : %X Blade_Reference_Elevation_Offset___Left:%f **\n",J1939_MESSAGE->Mxe.PGN,LLRE.Blade_Reference_Elevation_Offset___Left);
						USART_STR(USART2,data);
