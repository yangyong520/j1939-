...
typedef struct getRESET {
    struct RESET_byte1 {
        uint8_t Trip_Group_1:2;
        uint8_t Trip_Group_2___Proprietary:2;
    }RESET_byte1;
    struct RESET_byte1 bt1 ;
    struct RESET_byte3 {
        uint8_t Engine_Build_Hours_Reset:2;
        uint8_t Steering_Straight_Ahead_Position_Reset:2;
    }RESET_byte3;
    struct RESET_byte3 bt3 ;
} getRESET_t ;
...
typedef struct getEEC1 {
    ...
    uint8_t Engine_Demand_–_Percent_Torque;
} getEEC1_t ;
...
typedef struct getPTODE {
    struct PTODE_byte1 {
        uint8_t Enable_Switch_–_Transfer_case_output_shaft_PTO:2;
        uint8_t Enable_Switch_–_Transmission_output_shaft_PTO:2;
        uint8_t Enable_Switch_–_Transmission_input_shaft_PTO_2:2;
        uint8_t Enable_Switch_–_Transmission_input_shaft_PTO_1:2;
    }PTODE_byte1;
    ...
    struct PTODE_byte3 {
        uint8_t Engagement_Consent_–_Transfer_case_output_shaft_PTO:2;
        uint8_t Engagement_Consent_–_Transmission_output_shaft_PTO:2;
        uint8_t Engagement_Consent_–_Transmission_input_shaft_PTO_2:2;
        uint8_t Engagement_Consent_–_Transmission_input_shaft_PTO_1:2;
    }PTODE_byte3;
    ...
    struct PTODE_byte5 {
        uint8_t Engagement_Status_–_Transfer_case_output_shaft_PTO:2;
        uint8_t Engagement_Status_–_Transmission_output_shaft_PTO:2;
        uint8_t Engagement_Status_–_Transmission_input_shaft_PTO_2:2;
        uint8_t Engagement_Status_–_Transmission_input_shaft_PTO_1:2;
    }PTODE_byte5;
...
typedef struct getTR4 {
    struct TR4_byte0 {
        uint8_t Farebox_Service_Status:2;
        uint8_t Trip_Status:3;
        uint8_t Trip_Direction:4;
    }TR4_byte0;
    struct TR4_byte0 bt0 ;
    uint16_t Trip_Number;
    uint16_t Pattern_Number;
    uint16_t Assigned_Route;
    uint16_t Assigned_Run;
    uint16_t Assigned_Block;
    uint16_t Driver_s_farebox_security_code;
} getTR4_t ;
...
typedef struct getS2 {
    uint16_t Time_Since_Last_Service;
} getS2_t ;
typedef struct getSP2 {
    uint16_t Engine_External_Shutdown_Air_Supply_Pressure;
} getSP2_t ;
typedef struct getETH {
    uint8_t Number_of_Engine_Torque_History_Records;
    uint16_t Engine_Power;
    uint16_t Engine_Peak_Torque_1;
    uint16_t Engine_Peak_Torque_2;
    uint8_t Calibration_Record_Start_Month;
    uint8_t Calibration_Record_Start_Day;
    uint8_t Calibration_Record_Start_Year;
    uint32_t Calibration_Record_Duration_Time;
    struct ETH_byte1 {
        uint8_t Torque_Limiting_Feature_Status:2;
        uint8_t Engine_Torque_Limit_Feature:3;
    }ETH_byte1;
    struct ETH_byte1 bt1 ;
    uint16_t Transmission_Gear_Ratio_1;
    uint16_t Engine_Torque_Limit_1_Transmission;
    uint16_t Transmission_Gear_Ratio_2;
    uint16_t Engine_Torque_Limit_2_Transmission;
    uint16_t Transmission_Gear_Ratio_3;
    uint16_t Engine_Torque_Limit_3_Transmission;
    uint16_t Engine_Torque_Limit_4_Transmission;
    uint16_t Engine_Torque_Limit_5_Switch;
    uint16_t Engine_Torque_Limit_6_Axle_Input;
} getETH_t ;
...
typedef struct getSERV {
    uint16_t Service_Distance;
    uint8_t Service_Delay_Calendar_Time_Based;
    uint16_t Service_Delay_Operational_Time_Based;
} getSERV_t ;
...
typedef struct getRC {
    struct RC_byte1 {
        uint8_t Retarder_Type:4;
        uint8_t Retarder_Location:4;
    }RC_byte1;
    struct RC_byte1 bt1 ;
    uint8_t Retarder_Control_Method__Retarder_Configuration_;
    uint16_t Retarder_Speed_At_Idle_Point_1__Retarder_Configuration_;
    uint8_t Percent_Torque_At_Idle_Point_1__Retarder_Configuration_;
    uint16_t Maximum_Retarder_Speed_Point_2__Retarder_Configuration_;
    uint8_t Percent_Torque_At_Maximum_Speed_Point_2__Retarder_Configuration_;
    uint16_t Retarder_Speed_At_Point_3__Retarder_Configuration_;
    uint8_t Percent_Torque_At_Point_3__Retarder_Configuration_;
    uint16_t Retarder_Speed_At_Point_4__Retarder_Configuration_;
    uint8_t Percent_Torque_At_Point_4__Retarder_Configuration_;
    uint16_t Retarder_Speed_At_Peak_Torque_Point_5__Retarder_Configuration_;
    uint16_t Reference_Retarder_Torque__Retarder_Configuration_;
    uint8_t Percent_Torque_At_Peak_Torque_Point_5__Retarder_Configuration_;
} getRC_t ;
...
typedef struct getEC1 {
    uint16_t Engine_Speed_At_Idle_Point_1__Engine_Configuration_;
    uint8_t Engine_Percent_Torque_At_Idle_Point_1__Engine_Configuration_;
    uint16_t Engine_Speed_At_Point_2__Engine_Configuration_;
    uint8_t Engine_Percent_Torque_At_Point_2__Engine_Configuration_;
    uint16_t Engine_Speed_At_Point_3__Engine_Configuration_;
    uint8_t Engine_Percent_Torque_At_Point_3__Engine_Configuration_;
    uint16_t Engine_Speed_At_Point_4__Engine_Configuration_;
    uint8_t Engine_Percent_Torque_At_Point_4__Engine_Configuration_;
    uint16_t Engine_Speed_At_Point_5__Engine_Configuration_;
    uint8_t Engine_Percent_Torque_At_Point_5__Engine_Configuration_;
    uint16_t Engine_Speed_At_High_Idle_Point_6__Engine_Configuration_;
    uint16_t Engine_Gain__Kp__Of_The_Endspeed_Governor__Engine_Configuration_;
    uint16_t Engine_Reference_Torque__Engine_Configuration_;
    uint16_t Engine_Maximum_Momentary_Override_Speed_Point_7__Engine_Configuration_;
    uint8_t Engine_Maximum_Momentary_Override_Time_Limit__Engine_Configuration_;
    uint8_t Engine_Requested_Speed_Control_Range_Lower_Limit__Engine_Configuration_;
    uint8_t Engine_Requested_Speed_Control_Range_Upper_Limit__Engine_Configuration_;
    uint8_t Engine_Requested_Torque_Control_Range_Lower_Limit__Engine_Configuration_;
    uint8_t Engine_Requested_Torque_Control_Range_Upper_Limit__Engine_Configuration_;
    uint16_t Engine_Extended_Range_Requested_Speed_Control_Range_Upper_Limit__Engine_configuration_;
    uint16_t Engine_Moment_of_Inertia;
    uint16_t Engine_Default_Torque_Limit;
} getEC1_t ;
...
void RC ( J1939_MESSAGE_T *J1939_MESSAGE,getRC_t *RC);
